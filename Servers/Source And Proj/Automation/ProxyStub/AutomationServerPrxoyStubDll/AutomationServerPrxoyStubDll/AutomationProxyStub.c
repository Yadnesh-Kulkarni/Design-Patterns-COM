...
/* Object interface: ICubeCubeRoot, ver. 0.0,
   GUID={0xD8E55938,0xC58C,0x48F6,{0x8B,0xCA,0x4C,0xA7,0x38,0x0E,0xB4,0xC6}} */
...
CINTERFACE_PROXY_VTABLE(9) _ICubeCubeRootProxyVtbl = 
{
    ...
    (void *) (INT_PTR) -1 /* ICubeCubeRoot::CubeOfInteger */ ,
    (void *) (INT_PTR) -1 /* ICubeCubeRoot::CubeRootOfInteger */
};
