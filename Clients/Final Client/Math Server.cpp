...
void RegisterDlls()
{
	...
	hLib = LoadLibrary(TEXT("C:\\Users\\Yadnesh\\Documents\\Final_COM_Project\\MiddleWare\\Source\\DllRegisterAndUnRegister\\DllRegisterAndUnregister.dll"));
	if (hLib == NULL)
	{
...
void Square(int n1)
{
	...
	float fSquare;
	fSquare = pfn(n1);
	sprintf_s(str, TEXT("Square Of %d is %f"), n1, fSquare);
...
void SquareRoot(int n1)
{
	...
	float fSquareRoot;
	fSquareRoot = pfn(n1);
	sprintf_s(str, TEXT("Square Root Of %d is %f"), n1, fSquareRoot);
...
void Cube(int n1)
{
	...
	float fCube;
	fCube = pfn(n1);
	sprintf_s(str, TEXT("Cube Of %d is %f"), n1, fCube);
...
void CubeRoot(int n1)
{
	...
	float fCubeRoot;
	fCubeRoot = pfn(n1);
	sprintf_s(str, TEXT("Cube Root Of %d is %f"), n1, fCubeRoot);
