				   ...
				   LPSTR lpCmdLine,int nCmdShow)
{
	...
	hwnd=CreateWindow(AppName,
		              TEXT("Client Of Automation Server"),
					  WS_OVERLAPPEDWINDOW,
					  CW_USEDEFAULT,
					  CW_USEDEFAULT,
					  CW_USEDEFAULT,
...
LRESULT CALLBACK WndProc(HWND hwnd,UINT iMsg,WPARAM wParam,LPARAM lParam)
{
	...
	case WM_CREATE:
		...
		// get ISum Interface
		hr=CoCreateInstance(CLSID_CubeCubeRoot,
			                NULL,
		...
		{
			swprintf(str,sizeof(str), TEXT("Cube of %d is %f"),n1,vRet.fltVal);
			MessageBox(hwnd, str, TEXT("Cube Of Integer"), MB_OK);
		}
